...
export default function StudioPage() {
  const { user, setActiveTab, destinations, streamTitle, setStreamTitle } = useStore()
  ...
  const {
    videoRef, camOn, micOn, screenOn, quality, isLive, streamKey,
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-80 flex-shrink-0 flex flex-col"
          ...
          <UnifiedChat
            ...
            streamKey={streamKey}
            isLive={isLive}
            className="flex-1 min-h-0 mx-3 mb-3"
          />
